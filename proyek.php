...
<!-- Mirrored from preview.ryetheme.com/munia/single-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Apr 2019 06:16:18 GMT -->
<head>
        <!-- All Meta -->
        <meta charset="utf-8">
        ...
        <!-- page title -->
        <title>Java Geo Survey - Proyek</title> 
        <!--Favicon icon-->
    ...
    <body>
        ...
        <!--Start Munia-banner section -->
        <section class="munia-banner">
        ...
        </section><!--End Munia-banner section -->
                    ...
                    <div class="col-md-8">
                        <div class="single-blog-post">
                            <div class="single-blog-img">
                                <img src="../../admin/data/proyek/gambar/<?= $data['images']; ?>" class="img-responsive __img-mobile" alt="single">
                            </div>
                            <div class="blog-date">
                                <span><i class="fa fa-clock-o"></i><?= substr(date('d F Y', strtotime($data['date_proyek'])), 2, 30) ?></span>
                            </div>
                            <div class="single-blog-details">
                                <h3><?= $data['title']; ?></h3>
                                <p align="justify"><?= $data['description']; ?></p>
                                
                                <a href="/" button="input">Kembali</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2"></div>
